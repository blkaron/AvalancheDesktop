...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 581, 511))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setToolTip(_translate("MainWindow", "Open file for visualization"))
        self.pushButton_4.setText(_translate("MainWindow", "Open File"))
        self.pushButton.setToolTip(_translate("MainWindow", "Open serial connection for real time visualization"))
        self.pushButton.setText(_translate("MainWindow", "Open Serial Connection"))
